# Convention-correct EulerLite scaffold emitted by `/scaffold scheduler EulerLite`.
# The interface/contract is complete; the numerical update rule is a deliberate
# TODO. Do not treat the placeholder in `step` as a real Euler sampler.
...
class EulerLiteScheduler(SchedulerMixin, ConfigMixin):
    """A minimal, convention-correct Euler-style scheduler scaffold.
    ...
    update rule in `step` with the real Euler method.
    """
