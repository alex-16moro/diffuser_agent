...
- **[MUST] TEST001 New schedulers/models ship with a matching test file** (scheduler) — Generate a contract test from tests/_templates/scheduler_test.py. (source: conceptual/contribution.md (PR rule 9: high-coverage tests))
